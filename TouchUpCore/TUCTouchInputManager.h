...
/**
 Enable one-finger scrolling gesture
 */
@property BOOL isScrollingWithOneFingerEnabled;

/**
 Enable secondary click (right-click) with second finger
 */
@property BOOL isSecondaryClickEnabled;

/**
 Enable magnification (pinch) gesture
 */
@property BOOL isMagnificationEnabled;

/**
 Click window to front on touch down
 */
@property BOOL isClickWindowToFrontEnabled;

/**
 Perform click on finger lift instead of on down
 */
@property BOOL isClickOnLiftEnabled;
